...
function SearchResultsScreen({ onBack, query, onPickField, setTopBarLeading }) {
  ...
  return (
    <div style={{ position: 'relative', background: LL.bg, minHeight: '100%' }}>
      ...
      <div style={{
        position: 'sticky', top: 47, zIndex: 30, background: '#fff',
        boxShadow: '0 1px 0 rgba(0,0,0,0.06), 0 4px 12px rgba(0,0,0,0.04)',
      }}>
        {/* Top row — back left · search result title centre · spacer right */}
        <div style={{
          display: 'flex', alignItems: 'center', padding: '6px 12px 4px', gap: 4,
        }}>
          {/* Back button */}
          ...
          {/* Centre — search result title */}
          <div style={{
            flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 2,
          }}>
            <div style={{ fontSize: 15, fontWeight: 700, color: LL.text, letterSpacing: '-0.01em' }}>
              搜索结果
            </div>
            <div style={{ fontSize: 11.5, color: LL.text3, fontWeight: 500 }}>
              {q.svcType} · {q.address}
            </div>
          </div>
          {/* Spacer */}
