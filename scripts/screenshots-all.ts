...
const PAGES: PageSpec[] = [
  ...
  { path: 'pages/chat/index',              slug: 'chat-threads' },
  { path: 'pages/activity/index',          slug: 'activity' },
  ...
  { path: 'pages/search-results/index',    slug: 'search-results' },
  { path: 'pages/coupons/index',           slug: 'coupons' },
  { path: 'pages/invite/index',            slug: 'invite' },
  { path: 'pages/settings/index',          slug: 'settings' },
  { path: 'pages/about/index',             slug: 'about' },
  { path: 'pages/pets/index',              slug: 'pets' },
  { path: 'pages/caregiver-apply/index',   slug: 'caregiver-apply' },
  { path: 'pages/caregiver-home/index',    slug: 'caregiver-home' },
  { path: 'pages/caregiver-earnings/index',slug: 'caregiver-earnings' },
